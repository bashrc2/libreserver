...
This project does not allow contributions generated by large languages models (LLMs) and chatbots. This ban includes tools like ChatGPT, Claude, Cursor, Copilot, DeepSeek, and Devin AI. We are taking these steps due to:
...
This ban of AI generated content applies to all parts of the project, including, but not limited to, code, documentation, issues, and artworks. An exception applies for purely translating texts for Issues, Discussions, and their comments to English.
