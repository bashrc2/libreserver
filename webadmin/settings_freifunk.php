            ...
            if (is_numeric($longitude)) {
                if(filter_string('latitude',32)) {
                    ...
                    if (is_numeric($latitude)) {
                        ...
                        exec('cp settings_'.$network.'_template.html settings_'.$network.'.html');
                        exec("sed -i 's|YOURLONGITUDE|".$longitude."|g' settings_".$network.".html");
                        exec("sed -i 's|YOURLATITUDE|".$latitude."|g' settings_".$network.".html");
