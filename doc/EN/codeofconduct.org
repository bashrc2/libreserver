...
#+KEYWORDS: libreserver, code of conduct
#+DESCRIPTION: Code of Conduct for the LibreServer project
...
For public discussions about the project use the Matrix room *#libreserver:matrix.libreserver.net* or the XMPP support conference at *support@chat.libreserver.net*.
* No spamming
...
Private complaints should be sent to bob@libreserver.net, preferably via XMPP/Conversations with OMEMO enabled but you can also use the same address for email correspondence. If you're using email and have GPG capability the public key [[./support.html][can be found here]]. XMPP messages are likely to get the quickest response.
 ...
 * If they have a user account on *code.libreserver.net* it will be removed
